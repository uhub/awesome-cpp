...
* [kamyu104/LeetCode-Solutions](https://github.com/kamyu104/LeetCode-Solutions) - :octocat: (Weekly Update) Python / Modern C++ Solutions of All 1923 LeetCode Problems
...
* [BrutPitt/glChAoS.P](https://github.com/BrutPitt/glChAoS.P) - 3D GPUs Strange Attractors and Hypercomplex Fractals explorer - up to 256 Million particles in RealTime
...
* [ADJA/algos](https://github.com/ADJA/algos) - Competitive programming algorithms in C++
...
* [kamyu104/LintCode](https://github.com/kamyu104/LintCode) - 📘 C++11 Solutions of All 289 LintCode Problems (No More Updates)
* [boost-ext/sml](https://github.com/boost-ext/sml) - SML: C++14 State Machine Library
...
* [felixguendling/cista](https://github.com/felixguendling/cista) - Simple C++ Serialization & Reflection.
...
* [Seeed-Studio/Seeed_Arduino_CAN](https://github.com/Seeed-Studio/Seeed_Arduino_CAN) - Seeed Arduino CAN-BUS library - MCP2518FD&MCP2515&MCP2551
...
* [mull-project/mull](https://github.com/mull-project/mull) - Practical mutation testing tool for C and C++
...
* [CodeTest-StudyGroup/Code-Test-Study](https://github.com/CodeTest-StudyGroup/Code-Test-Study) - 코딩 테스트 관련 기출문항을 풀어보고 소스코드 및 설명을 업로드합니다. (문제 추천은 Discussions에 들어가셔서 자유롭게 가능합니다.)
...
* [Siv3D/OpenSiv3D](https://github.com/Siv3D/OpenSiv3D) - 🦖 C++17/C++20 framework for creative coding
...
* [wlgq2/uv-cpp](https://github.com/wlgq2/uv-cpp) - libuv wrapper in C++11 /libuv C++11网络库
* [yourWaifu/sleepy-discord](https://github.com/yourWaifu/sleepy-discord) - C++ library for the Discord chat client
* [yasio/yasio](https://github.com/yasio/yasio) - A multi-platform support c++11 library with focus on asio (asynchronous socket I/O) for any client application.
...
* [TomHarte/CLK](https://github.com/TomHarte/CLK) - A latency-hating emulator of 8- and 16-bit platforms: the Acorn Electron, Amstrad CPC, Apple II/II+/IIe and early Macintosh, Atari 2600 and ST, ColecoVision, Enterprise 64/128, Commodore Vic-20, MSX 1, Oric 1/Atmos, Sega Master System, Sinclair ZX80/81 and ZX Spectrum.
...
* [purecpp-org/cinatra](https://github.com/purecpp-org/cinatra) - A sinatra inspired modern c++ web framework
...
* [downdemo/Cpp-Concurrency-in-Action-2ed](https://github.com/downdemo/Cpp-Concurrency-in-Action-2ed) - 📚 C++ Concurrency in Action 2ed 笔记：C++11/14/17 多线程技术
...
* [shichaoy/cube_slam](https://github.com/shichaoy/cube_slam) - CubeSLAM: Monocular 3D Object Detection and SLAM
* [sbarex/SourceCodeSyntaxHighlight](https://github.com/sbarex/SourceCodeSyntaxHighlight) - Quick Look extension for highlight source code files on macOS Catalina and Big Sur.
...
* [joboccara/NamedType](https://github.com/joboccara/NamedType) - Implementation of strong types in C++
* [etr/libhttpserver](https://github.com/etr/libhttpserver) - C++ library for creating an embedded Rest HTTP server (and more)
* [JuliaComputingOSS/llvm-cbe](https://github.com/JuliaComputingOSS/llvm-cbe) - resurrected LLVM "C Backend", with improvements
...
* [tgfrerer/island](https://github.com/tgfrerer/island) - 🌋🐎 Project Island is an experimental, hot-reloading Vulkan renderer/proto-engine for Linux and Windows, written in C/C++.
...
* [xia-chu/ZLToolKit](https://github.com/xia-chu/ZLToolKit) - 一个基于C++11的轻量级网络框架，基于线程池技术可以实现大并发网络IO
* [KimYangOfCat/CSPostgraduate-408](https://github.com/KimYangOfCat/CSPostgraduate-408) - 💯  CSPostgraduate 计算机考研 408 专业课资料及真题资源～✍🏻 更新中～欢迎Star！⭐️
...
* [facebookarchive/fb-caffe-exts](https://github.com/facebookarchive/fb-caffe-exts) - Some handy utility libraries and tools for the Caffe deep learning framework.
...
* [SonarOpenCommunity/sonar-cxx](https://github.com/SonarOpenCommunity/sonar-cxx) - SonarQube C++ plugin (Community): This plugin adds C++ support to SonarQube with the focus on integration of existing C++ tools.
* [norbusan/sony-control-center](https://github.com/norbusan/sony-control-center) - Fork of the sony-f11-vaio-control-center to work with newer kernels and with all Sony laptops supported by the sony-laptop kernel module.
...
* [taskflow/taskflow](https://github.com/taskflow/taskflow) - Parallel and Heterogeneous Task Programming in Modern C++
...
* [leovandriel/caffe2_cpp_tutorial](https://github.com/leovandriel/caffe2_cpp_tutorial) - C++ transcripts of the Caffe2 Python tutorials and other C++ example code
...
* [SharpAI/DeepCamera](https://github.com/SharpAI/DeepCamera) - SharpAI is open source stack for machine learning engineering with private deployment and AutoML for edge computing.  DeepCamera is application of SharpAI designed for connecting computer vision model to surveillance camera. Developers can run same code on Raspberry Pi/Android/PC/AWS to boost your AI production development.
...
* [KoderzUnreal/RuntimeMeshComponent](https://github.com/KoderzUnreal/RuntimeMeshComponent) - Unreal Engine 4 plugin component for rendering runtime generated content.
...
* [sumeetchhetri/ffead-cpp](https://github.com/sumeetchhetri/ffead-cpp) - Framework for Enterprise Application Development, webrtc signalling server, peerjs webrtc, c++ framework, c++ web framework, c++ application framework, c++ rest framework, c++ soap framework, c++ web sites, c++ web applications, c++ driven web development - c++
...
* [Stream-AD/MIDAS](https://github.com/Stream-AD/MIDAS) - Anomaly Detection on Dynamic (time-evolving) Graphs in Real-time and Streaming manner. Detecting intrusions (DoS and DDoS attacks), frauds, fake rating anomalies. C++, Golang, Python, R, Rust, Ruby implementations.
* [SVF-tools/SVF](https://github.com/SVF-tools/SVF) - Static Value-Flow Analysis for C and C++ Programs
* [QuantStack/mamba](https://github.com/QuantStack/mamba) - A FAST drop-in replacement for the conda command-line utility, in C++
...
* [CXXGraph](https://github.com/ZigRazor/CXXGraph) - Header-Only Graph library for C++ ( >= 17 ).
