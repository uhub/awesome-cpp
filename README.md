...
* [kamyu104/LeetCode-Solutions](https://github.com/kamyu104/LeetCode-Solutions) - :octocat: (Weekly Update) Python / Modern C++ Solutions of All 1697 LeetCode Problems
...
* [PatWie/CppNumericalSolvers](https://github.com/PatWie/CppNumericalSolvers) - a lightweight C++14 library of numerical optimization methods for nonlinear functions (Including L-BFGS-B for TensorFlow or pure C++11/C++14)
...
* [RSATom/WebChimera.js](https://github.com/RSATom/WebChimera.js) - [BROKEN] libvlc binding for node.js/io.js/Node-Webkit/NW.js/Electron
...
* [gulrak/filesystem](https://github.com/gulrak/filesystem) - An implementation of C++17 std::filesystem for C++11 /C++14/C++17 on Windows, macOS, Linux and FreeBSD.
...
* [yasio/yasio](https://github.com/yasio/yasio) - A multi-platform support c++11 library with focus on asio (asynchronous socket I/O) for any client application, support windows & linux & apple & android & win10-universal.
...
* [TomHarte/CLK](https://github.com/TomHarte/CLK) - A latency-hating emulator of 8- and 16-bit platforms: the Acorn Electron, Amstrad CPC, Apple II/II+/IIe and early Macintosh, Atari 2600 and ST, ColecoVision, Commodore Vic-20, MSX 1, Oric 1/Atmos, Sega Master System and Sinclair ZX80/81.
