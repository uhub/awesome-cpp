...
* [NovaMods/nova-renderer](https://github.com/NovaMods/nova-renderer) - A mod to replace Minecraft's renderer with an OpenGL 4.5 renderer written in C++. A project of Continuum Graphics LLC
